...
def testPRT(dir_path, n=40):
    ...
    obj_path = glob.glob(os.path.join(dir_path, '*.obj'))[0]
    # obj_path = os.path.join(dir_path, sub_name + '0001.obj')
...
if __name__ == '__main__':
    ...
    # parser.add_argument('-i', '--input', type=str, default='/media/mana/mana/dataset/THuman2.0_Release/0001')
