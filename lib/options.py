...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_data.add_argument('--dataroot', type=str, default='/media/mana/mana/dataset/Titmouse_pifu',
        ...
        g_train.add_argument('--reso_grid_list', nargs='+', default=[128, 64, 32, 16], help='# resolution list of grid')
        g_train.add_argument('--use_multi_pcd', type=bool, default=True, help='use_multi_pcd')
        ...
        g_sample.add_argument('--sigma', type=float, default=2.0, help='perturbation standard deviation for positions')
